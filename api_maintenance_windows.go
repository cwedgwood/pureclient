...
/*
MaintenanceWindowsApiService Delete maintenance window
 ...
 * @param optional nil or *MaintenanceWindowsApiApi28MaintenanceWindowsDeleteOpts - Optional Parameters:
...
type MaintenanceWindowsApiApi28MaintenanceWindowsDeleteOpts struct {
    Authorization optional.String
    XRequestID optional.String
    Names optional.Interface
}

func (a *MaintenanceWindowsApiService) Api28MaintenanceWindowsDelete(ctx context.Context, localVarOptionals *MaintenanceWindowsApiApi28MaintenanceWindowsDeleteOpts) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/2.8/maintenance-windows"
...
/*
MaintenanceWindowsApiService List maintenance window details
Displays maintenance window details, including start time, end time, and maintenance type.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *MaintenanceWindowsApiApi28MaintenanceWindowsGetOpts - Optional Parameters:
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint (except &#x60;/oauth2&#x60;, &#x60;/login&#x60;, and &#x60;/logout&#x60;)
     * @param "XRequestID" (optional.String) -  Supplied by client during request or generated by server.
...
type MaintenanceWindowsApiApi28MaintenanceWindowsGetOpts struct {
    Authorization optional.String
    XRequestID optional.String
...
func (a *MaintenanceWindowsApiService) Api28MaintenanceWindowsGet(ctx context.Context, localVarOptionals *MaintenanceWindowsApiApi28MaintenanceWindowsGetOpts) (InlineResponse20083, *http.Response, error) {
	var (
...
/*
MaintenanceWindowsApiService Create a maintenance window
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
 * @param optional nil or *MaintenanceWindowsApiApi28MaintenanceWindowsPostOpts - Optional Parameters:
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint (except &#x60;/oauth2&#x60;, &#x60;/login&#x60;, and &#x60;/logout&#x60;)
     * @param "XRequestID" (optional.String) -  Supplied by client during request or generated by server.
     * @param "Names" (optional.Interface of []string) -  Performs the operation on the unique name specified. Enter multiple names in comma-separated format. For example, &#x60;name01,name02&#x60;.
...
type MaintenanceWindowsApiApi28MaintenanceWindowsPostOpts struct {
    Authorization optional.String
    XRequestID optional.String
    Names optional.Interface
}

func (a *MaintenanceWindowsApiService) Api28MaintenanceWindowsPost(ctx context.Context, body Model28MaintenancewindowsBody, localVarOptionals *MaintenanceWindowsApiApi28MaintenanceWindowsPostOpts) (InlineResponse20084, *http.Response, error) {
	var (
