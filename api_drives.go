...
/*
DrivesApiService List flash, NVRAM, and cache modules
 ...
 * @param optional nil or *DrivesApiApi28DrivesGetOpts - Optional Parameters:
...
type DrivesApiApi28DrivesGetOpts struct {
...
func (a *DrivesApiService) Api28DrivesGet(ctx context.Context, localVarOptionals *DrivesApiApi28DrivesGetOpts) (InlineResponse20064, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/2.8/drives"
...
/*
DrivesApiService Modify flash and NVRAM modules
Modifies flash and NVRAM modules that have been added or connected but not yet admitted to the array.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *DrivesApiApi28DrivesPatchOpts - Optional Parameters:
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint (except &#x60;/oauth2&#x60;, &#x60;/login&#x60;, and &#x60;/logout&#x60;)
     * @param "XRequestID" (optional.String) -  Supplied by client during request or generated by server.
     * @param "Admit" (optional.Bool) -  If &#x60;true&#x60;, admits any &#x60;unadmitted&#x60; drives into the system.
@return InlineResponse20065
*/

type DrivesApiApi28DrivesPatchOpts struct {
    Authorization optional.String
    XRequestID optional.String
    Admit optional.Bool
}

func (a *DrivesApiService) Api28DrivesPatch(ctx context.Context, localVarOptionals *DrivesApiApi28DrivesPatchOpts) (InlineResponse20065, *http.Response, error) {
	var (
	...
	if localVarOptionals != nil && localVarOptionals.Admit.IsSet() {
		localVarQueryParams.Add("admit", parameterToString(localVarOptionals.Admit.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
