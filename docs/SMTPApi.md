...
------------- | ------------- | -------------
[**Api28SmtpServersGet**](SMTPApi.md#Api28SmtpServersGet) | **Get** /api/2.8/smtp-servers | List SMTP server attributes
[**Api28SmtpServersPatch**](SMTPApi.md#Api28SmtpServersPatch) | **Patch** /api/2.8/smtp-servers | Modify SMTP server attributes

# **Api28SmtpServersGet**
> InlineResponse200138 Api28SmtpServersGet(ctx, optional)
 ...
 **optional** | ***SMTPApiApi28SmtpServersGetOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a SMTPApiApi28SmtpServersGetOpts struct
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
...
# **Api28SmtpServersPatch**
> InlineResponse200139 Api28SmtpServersPatch(ctx, body, optional)
 ...
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
  **body** | [**Smtp**](Smtp.md)|  | 
 **optional** | ***SMTPApiApi28SmtpServersPatchOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a SMTPApiApi28SmtpServersPatchOpts struct
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
