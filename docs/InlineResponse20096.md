...
**Items** | [**[]PodPerformanceReplication**](PodPerformanceReplication.md) | A list of pod performance replication objects. | [optional] [default to null]
**Total** | [**[]PodPerformanceReplication**](PodPerformanceReplication.md) | The aggregate value of all items after filtering. For real-time performance, the values are aggregated for the latest timestamp. For historical performance, the values are aggregated for each timestamp from &#x60;start_time&#x60; to &#x60;end_time&#x60;. When applicable, the average value is displayed instead. The values are displayed for each field if meaningful. | [optional] [default to null]
