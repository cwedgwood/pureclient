...
------------- | ------------- | -------------
[**Api28HardwareGet**](HardwareApi.md#Api28HardwareGet) | **Get** /api/2.8/hardware | List hardware component information
[**Api28HardwarePatch**](HardwareApi.md#Api28HardwarePatch) | **Patch** /api/2.8/hardware | Modify visual identification

# **Api28HardwareGet**
> InlineResponse20068 Api28HardwareGet(ctx, optional)
 ...
 **optional** | ***HardwareApiApi28HardwareGetOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a HardwareApiApi28HardwareGetOpts struct
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
...
# **Api28HardwarePatch**
> InlineResponse20069 Api28HardwarePatch(ctx, body, optional)
...
------------- | ------------- | ------------- | -------------
 **ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
  **body** | [**Model28HardwareBody**](Model28HardwareBody.md)|  | 
 **optional** | ***HardwareApiApi28HardwarePatchOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a HardwareApiApi28HardwarePatchOpts struct
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
