...
**Items** | [**[]RemoteProtectionGroupSnapshotTransfer**](RemoteProtectionGroupSnapshotTransfer.md) |  | [optional] [default to null]
**Total** | [**[]RemoteProtectionGroupSnapshotTransfer**](RemoteProtectionGroupSnapshotTransfer.md) | The aggregate value of all items after filtering. Where it makes more sense, the average value is displayed instead. The values are displayed for each field where meaningful. | [optional] [default to null]
