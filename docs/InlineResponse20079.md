...
**Items** | [**[]HostPerformanceBalance**](HostPerformanceBalance.md) | A list of entries indicating count and percentage of I/O operations across various data paths between the host and the array. | [optional] [default to null]
