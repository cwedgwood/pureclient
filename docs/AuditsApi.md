...
------------- | ------------- | -------------
[**Api28AuditsGet**](AuditsApi.md#Api28AuditsGet) | **Get** /api/2.8/audits | List audits

# **Api28AuditsGet**
> InlineResponse20037 Api28AuditsGet(ctx, optional)
List audits
 ...
 **optional** | ***AuditsApiApi28AuditsGetOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a AuditsApiApi28AuditsGetOpts struct
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
