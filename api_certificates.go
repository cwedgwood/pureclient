...
/*
CertificatesApiService Create certificate signing request
Creates a certificate signing request based on the certificate type and parameters.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
 * @param optional nil or *CertificatesApiApi28CertificatesCertificateSigningRequestsPostOpts - Optional Parameters:
...
type CertificatesApiApi28CertificatesCertificateSigningRequestsPostOpts struct {
    Authorization optional.String
    XRequestID optional.String
}

func (a *CertificatesApiService) Api28CertificatesCertificateSigningRequestsPost(ctx context.Context, body CertificatesCertificatesigningrequestsBody, localVarOptionals *CertificatesApiApi28CertificatesCertificateSigningRequestsPostOpts) (InlineResponse20040, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/2.8/certificates/certificate-signing-requests"
...
/*
CertificatesApiService Delete certificate
Deletes a specific certificate object.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *CertificatesApiApi28CertificatesDeleteOpts - Optional Parameters:
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint (except &#x60;/oauth2&#x60;, &#x60;/login&#x60;, and &#x60;/logout&#x60;)
     * @param "XRequestID" (optional.String) -  Supplied by client during request or generated by server.
...
type CertificatesApiApi28CertificatesDeleteOpts struct {
    Authorization optional.String
    XRequestID optional.String
    Names optional.Interface
}

func (a *CertificatesApiService) Api28CertificatesDelete(ctx context.Context, localVarOptionals *CertificatesApiApi28CertificatesDeleteOpts) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/2.8/certificates"
...
/*
CertificatesApiService List certificate attributes
Displays certificate attributes.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *CertificatesApiApi28CertificatesGetOpts - Optional Parameters:
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint (except &#x60;/oauth2&#x60;, &#x60;/login&#x60;, and &#x60;/logout&#x60;)
     * @param "XRequestID" (optional.String) -  Supplied by client during request or generated by server.
...
type CertificatesApiApi28CertificatesGetOpts struct {
    Authorization optional.String
    XRequestID optional.String
...
func (a *CertificatesApiService) Api28CertificatesGet(ctx context.Context, localVarOptionals *CertificatesApiApi28CertificatesGetOpts) (InlineResponse20038, *http.Response, error) {
	var (
...
/*
CertificatesApiService Modify certificates
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
 * @param optional nil or *CertificatesApiApi28CertificatesPatchOpts - Optional Parameters:
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint (except &#x60;/oauth2&#x60;, &#x60;/login&#x60;, and &#x60;/logout&#x60;)
     * @param "XRequestID" (optional.String) -  Supplied by client during request or generated by server.
     * @param "Names" (optional.Interface of []string) -  Performs the operation on the unique name specified. Enter multiple names in comma-separated format. For example, &#x60;name01,name02&#x60;.
     * @param "GenerateNewKey" (optional.Bool) -  If set to &#x60;true&#x60;, a new private key is generated when generating a new certificate with the specified attributes. This may not be set to &#x60;true&#x60; when importing a certificate and private key, and may not be set to &#x60;false&#x60; when generating a new self-signed certificate to replace a certificate that was imported. Default setting is &#x60;false&#x60;.
@return InlineResponse20039
*/

type CertificatesApiApi28CertificatesPatchOpts struct {
    Authorization optional.String
    XRequestID optional.String
    Names optional.Interface
    GenerateNewKey optional.Bool
}

func (a *CertificatesApiService) Api28CertificatesPatch(ctx context.Context, body Certificate, localVarOptionals *CertificatesApiApi28CertificatesPatchOpts) (InlineResponse20039, *http.Response, error) {
	var (
	...
	if localVarOptionals != nil && localVarOptionals.GenerateNewKey.IsSet() {
		localVarQueryParams.Add("generate_new_key", parameterToString(localVarOptionals.GenerateNewKey.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{"application/json"}
...
/*
CertificatesApiService Create certificate
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
 * @param optional nil or *CertificatesApiApi28CertificatesPostOpts - Optional Parameters:
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint (except &#x60;/oauth2&#x60;, &#x60;/login&#x60;, and &#x60;/logout&#x60;)
     * @param "XRequestID" (optional.String) -  Supplied by client during request or generated by server.
     * @param "Names" (optional.Interface of []string) -  Performs the operation on the unique name specified. Enter multiple names in comma-separated format. For example, &#x60;name01,name02&#x60;.
@return InlineResponse20039
...
type CertificatesApiApi28CertificatesPostOpts struct {
    Authorization optional.String
    XRequestID optional.String
    Names optional.Interface
}

func (a *CertificatesApiService) Api28CertificatesPost(ctx context.Context, body Certificate, localVarOptionals *CertificatesApiApi28CertificatesPostOpts) (InlineResponse20039, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
