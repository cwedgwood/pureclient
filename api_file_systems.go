...
/*
FileSystemsApiService Delete file system
 ...
 * @param optional nil or *FileSystemsApiApi28FileSystemsDeleteOpts - Optional Parameters:
...
type FileSystemsApiApi28FileSystemsDeleteOpts struct {
...
func (a *FileSystemsApiService) Api28FileSystemsDelete(ctx context.Context, localVarOptionals *FileSystemsApiApi28FileSystemsDeleteOpts) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/2.8/file-systems"
...
/*
FileSystemsApiService List file systems
Displays a list of file systems, including those pending eradication.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FileSystemsApiApi28FileSystemsGetOpts - Optional Parameters:
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint (except &#x60;/oauth2&#x60;, &#x60;/login&#x60;, and &#x60;/logout&#x60;)
     * @param "XRequestID" (optional.String) -  Supplied by client during request or generated by server.
...
type FileSystemsApiApi28FileSystemsGetOpts struct {
    Authorization optional.String
    XRequestID optional.String
...
func (a *FileSystemsApiService) Api28FileSystemsGet(ctx context.Context, localVarOptionals *FileSystemsApiApi28FileSystemsGetOpts) (InlineResponse20066, *http.Response, error) {
	var (
...
/*
FileSystemsApiService Modify a file system
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
 * @param optional nil or *FileSystemsApiApi28FileSystemsPatchOpts - Optional Parameters:
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint (except &#x60;/oauth2&#x60;, &#x60;/login&#x60;, and &#x60;/logout&#x60;)
     * @param "XRequestID" (optional.String) -  Supplied by client during request or generated by server.
     * @param "Ids" (optional.Interface of []string) -  Performs the operation on the unique resource IDs specified. Enter multiple resource IDs in comma-separated format. The &#x60;ids&#x60; and &#x60;names&#x60; parameters cannot be provided together.
     * @param "Names" (optional.Interface of []string) -  Performs the operation on the unique name specified. Enter multiple names in comma-separated format. For example, &#x60;name01,name02&#x60;.
...
type FileSystemsApiApi28FileSystemsPatchOpts struct {
    Authorization optional.String
    XRequestID optional.String
    Ids optional.Interface
    Names optional.Interface
...
//REDDY: body type could be wrong
func (a *FileSystemsApiService) Api28FileSystemsPatch(ctx context.Context, body FileSystem, localVarOptionals *FileSystemsApiApi28FileSystemsPatchOpts) (InlineResponse20067, *http.Response, error) {
	var (
...
/*
FileSystemsApiService Create file system
 ...
 * @param optional nil or *FileSystemsApiApi28FileSystemsPostOpts - Optional Parameters:
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint (except &#x60;/oauth2&#x60;, &#x60;/login&#x60;, and &#x60;/logout&#x60;)
     * @param "XRequestID" (optional.String) -  Supplied by client during request or generated by server.
@return InlineResponse20067
*/

type FileSystemsApiApi28FileSystemsPostOpts struct {
    Authorization optional.String
    XRequestID optional.String
}

func (a *FileSystemsApiService) Api28FileSystemsPost(ctx context.Context, names []string, localVarOptionals *FileSystemsApiApi28FileSystemsPostOpts) (InlineResponse20067, *http.Response, error) {
	var (
