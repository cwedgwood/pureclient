...
/*
RemotePodsApiService List remote pods
Returns a list of pods that that are on connected arrays but not stretched to this array.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *RemotePodsApiApi28RemotePodsGetOpts - Optional Parameters:
...
type RemotePodsApiApi28RemotePodsGetOpts struct {
...
func (a *RemotePodsApiService) Api28RemotePodsGet(ctx context.Context, localVarOptionals *RemotePodsApiApi28RemotePodsGetOpts) (InlineResponse200126, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/2.8/remote-pods"
