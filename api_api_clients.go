 ...
 * @param optional nil or *APIClientsApiApi28ApiClientsDeleteOpts - Optional Parameters:
...
type APIClientsApiApi28ApiClientsDeleteOpts struct {
...
func (a *APIClientsApiService) Api28ApiClientsDelete(ctx context.Context, localVarOptionals *APIClientsApiApi28ApiClientsDeleteOpts) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/2.8/api-clients"
...
/*
APIClientsApiService List API clients
Returns a list of API clients.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *APIClientsApiApi28ApiClientsGetOpts - Optional Parameters:
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint (except &#x60;/oauth2&#x60;, &#x60;/login&#x60;, and &#x60;/logout&#x60;)
     * @param "XRequestID" (optional.String) -  Supplied by client during request or generated by server.
...
type APIClientsApiApi28ApiClientsGetOpts struct {
    Authorization optional.String
    XRequestID optional.String
...
func (a *APIClientsApiService) Api28ApiClientsGet(ctx context.Context, localVarOptionals *APIClientsApiApi28ApiClientsGetOpts) (InlineResponse20017, *http.Response, error) {
	var (
...
/*
APIClientsApiService Manage an API client
Enables or disables an API client. The &#x60;ids&#x60; or &#x60;names&#x60; parameter is required, but cannot be set together.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
 * @param optional nil or *APIClientsApiApi28ApiClientsPatchOpts - Optional Parameters:
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint (except &#x60;/oauth2&#x60;, &#x60;/login&#x60;, and &#x60;/logout&#x60;)
     * @param "XRequestID" (optional.String) -  Supplied by client during request or generated by server.
     * @param "Ids" (optional.Interface of []string) -  Performs the operation on the unique resource IDs specified. Enter multiple resource IDs in comma-separated format. The &#x60;ids&#x60; and &#x60;names&#x60; parameters cannot be provided together.
     * @param "Names" (optional.Interface of []string) -  Performs the operation on the unique name specified. Enter multiple names in comma-separated format. For example, &#x60;name01,name02&#x60;.
...
type APIClientsApiApi28ApiClientsPatchOpts struct {
    Authorization optional.String
    XRequestID optional.String
    Ids optional.Interface
    Names optional.Interface
...
func (a *APIClientsApiService) Api28ApiClientsPatch(ctx context.Context, body Model28ApiclientsBody1, localVarOptionals *APIClientsApiApi28ApiClientsPatchOpts) (InlineResponse20018, *http.Response, error) {
	var (
...
/*
APIClientsApiService Create an API client
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
 * @param optional nil or *APIClientsApiApi28ApiClientsPostOpts - Optional Parameters:
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint (except &#x60;/oauth2&#x60;, &#x60;/login&#x60;, and &#x60;/logout&#x60;)
     * @param "XRequestID" (optional.String) -  Supplied by client during request or generated by server.
     * @param "Names" (optional.Interface of []string) -  Performs the operation on the unique name specified. Enter multiple names in comma-separated format. For example, &#x60;name01,name02&#x60;.
@return InlineResponse20018
...
type APIClientsApiApi28ApiClientsPostOpts struct {
    Authorization optional.String
    XRequestID optional.String
    Names optional.Interface
}

func (a *APIClientsApiService) Api28ApiClientsPost(ctx context.Context, body Model28ApiclientsBody, localVarOptionals *APIClientsApiApi28ApiClientsPostOpts) (InlineResponse20018, *http.Response, error) {
	var (
