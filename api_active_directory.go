...
/*
ActiveDirectoryApiService Delete Active Directory account
 ...
 * @param optional nil or *ActiveDirectoryApiApi28ActiveDirectoryDeleteOpts - Optional Parameters:
     ...
     * @param "LocalOnly" (optional.Bool) -  If specified as &#x60;true&#x60;, only delete the Active Directory configuration on the local array, without deleting the computer account created in the Active Directory domain. If not specified, defaults to &#x60;false&#x60;.

*/

type ActiveDirectoryApiApi28ActiveDirectoryDeleteOpts struct {
    Authorization optional.String
    XRequestID optional.String
    LocalOnly optional.Bool
}

func (a *ActiveDirectoryApiService) Api28ActiveDirectoryDelete(ctx context.Context, names []string, localVarOptionals *ActiveDirectoryApiApi28ActiveDirectoryDeleteOpts) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/2.8/active-directory"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}

	if localVarOptionals != nil && localVarOptionals.LocalOnly.IsSet() {
		localVarQueryParams.Add("local_only", parameterToString(localVarOptionals.LocalOnly.Value(), ""))
	}
...
/*
ActiveDirectoryApiService List Active Directory attributes
Displays configured Active Directory attributes.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ActiveDirectoryApiApi28ActiveDirectoryGetOpts - Optional Parameters:
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint (except &#x60;/oauth2&#x60;, &#x60;/login&#x60;, and &#x60;/logout&#x60;)
     * @param "XRequestID" (optional.String) -  Supplied by client during request or generated by server.
...
type ActiveDirectoryApiApi28ActiveDirectoryGetOpts struct {
    Authorization optional.String
    XRequestID optional.String
...
func (a *ActiveDirectoryApiService) Api28ActiveDirectoryGet(ctx context.Context, localVarOptionals *ActiveDirectoryApiApi28ActiveDirectoryGetOpts) (InlineResponse2002, *http.Response, error) {
	var (
...
/*
ActiveDirectoryApiService Create Active Directory account
 ...
 * @param body
 * @param names Performs the operation on the unique name specified. For example, &#x60;name01&#x60;. Enter multiple names in comma-separated format.
 * @param optional nil or *ActiveDirectoryApiApi28ActiveDirectoryPostOpts - Optional Parameters:
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint (except &#x60;/oauth2&#x60;, &#x60;/login&#x60;, and &#x60;/logout&#x60;)
     * @param "XRequestID" (optional.String) -  Supplied by client during request or generated by server.
@return InlineResponse2003
*/

type ActiveDirectoryApiApi28ActiveDirectoryPostOpts struct {
    Authorization optional.String
    XRequestID optional.String
}

func (a *ActiveDirectoryApiService) Api28ActiveDirectoryPost(ctx context.Context, body Model28ActivedirectoryBody, names []string, localVarOptionals *ActiveDirectoryApiApi28ActiveDirectoryPostOpts) (InlineResponse2003, *http.Response, error) {
	var (
