...
/*
DirectoryExportsApiService Delete directory exports
 ...
 * @param optional nil or *DirectoryExportsApiApi28DirectoryExportsDeleteOpts - Optional Parameters:
     ...
     * @param "ExportNames" (optional.Interface of []string) -  Performs the operation on the export names specified. Enter multiple names in comma-separated format. For example, &#x60;name01,name02&#x60;.
...
type DirectoryExportsApiApi28DirectoryExportsDeleteOpts struct {
    Authorization optional.String
    XRequestID optional.String
    ExportNames optional.Interface
    PolicyIds optional.Interface
    PolicyNames optional.Interface
}

func (a *DirectoryExportsApiService) Api28DirectoryExportsDelete(ctx context.Context, localVarOptionals *DirectoryExportsApiApi28DirectoryExportsDeleteOpts) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/2.8/directory-exports"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}

	if localVarOptionals != nil && localVarOptionals.ExportNames.IsSet() {
		localVarQueryParams.Add("export_names", parameterToString(localVarOptionals.ExportNames.Value(), "csv"))
	}
...
/*
DirectoryExportsApiService List directory exports
Displays a list of directory exports.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *DirectoryExportsApiApi28DirectoryExportsGetOpts - Optional Parameters:
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint (except &#x60;/oauth2&#x60;, &#x60;/login&#x60;, and &#x60;/logout&#x60;)
     * @param "XRequestID" (optional.String) -  Supplied by client during request or generated by server.
...
type DirectoryExportsApiApi28DirectoryExportsGetOpts struct {
    Authorization optional.String
    XRequestID optional.String
...
func (a *DirectoryExportsApiService) Api28DirectoryExportsGet(ctx context.Context, localVarOptionals *DirectoryExportsApiApi28DirectoryExportsGetOpts) (InlineResponse20052, *http.Response, error) {
	var (
...
/*
DirectoryExportsApiService Create directory exports
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
 * @param optional nil or *DirectoryExportsApiApi28DirectoryExportsPostOpts - Optional Parameters:
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint (except &#x60;/oauth2&#x60;, &#x60;/login&#x60;, and &#x60;/logout&#x60;)
     * @param "XRequestID" (optional.String) -  Supplied by client during request or generated by server.
     * @param "DirectoryIds" (optional.Interface of []string) -  Performs the operation on the unique managed directory IDs specified. Enter multiple managed directory IDs in comma-separated format. The &#x60;directory_ids&#x60; and &#x60;directory_names&#x60; parameters cannot be provided together.
     * @param "DirectoryNames" (optional.Interface of []string) -  Performs the operation on the managed directory names specified. Enter multiple full managed directory names in comma-separated format. For example, &#x60;fs:dir01,fs:dir02&#x60;.
...
type DirectoryExportsApiApi28DirectoryExportsPostOpts struct {
    Authorization optional.String
    XRequestID optional.String
    DirectoryIds optional.Interface
    DirectoryNames optional.Interface
...
func (a *DirectoryExportsApiService) Api28DirectoryExportsPost(ctx context.Context, body Model28DirectoryexportsBody, localVarOptionals *DirectoryExportsApiApi28DirectoryExportsPostOpts) (InlineResponse20053, *http.Response, error) {
	var (
