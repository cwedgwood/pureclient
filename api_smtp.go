...
/*
SMTPApiService List SMTP server attributes
 ...
 * @param optional nil or *SMTPApiApi28SmtpServersGetOpts - Optional Parameters:
...
type SMTPApiApi28SmtpServersGetOpts struct {
...
func (a *SMTPApiService) Api28SmtpServersGet(ctx context.Context, localVarOptionals *SMTPApiApi28SmtpServersGetOpts) (InlineResponse200138, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/2.8/smtp-servers"
...
/*
SMTPApiService Modify SMTP server attributes
Modifies SMTP server attributes. Values include &#x60;user_name&#x60;, &#x60;password&#x60;, &#x60;relay_host&#x60;, &#x60;sender_domain&#x60;, and &#x60;name&#x60;.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
 * @param optional nil or *SMTPApiApi28SmtpServersPatchOpts - Optional Parameters:
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint (except &#x60;/oauth2&#x60;, &#x60;/login&#x60;, and &#x60;/logout&#x60;)
     * @param "XRequestID" (optional.String) -  Supplied by client during request or generated by server.
@return InlineResponse200139
*/

type SMTPApiApi28SmtpServersPatchOpts struct {
    Authorization optional.String
    XRequestID optional.String
}

func (a *SMTPApiService) Api28SmtpServersPatch(ctx context.Context, body Smtp, localVarOptionals *SMTPApiApi28SmtpServersPatchOpts) (InlineResponse200139, *http.Response, error) {
	var (
