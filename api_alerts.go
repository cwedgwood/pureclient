...
/*
AlertsApiService List alert events
Displays a list of alert events.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *AlertsApiApi28AlertsEventsGetOpts - Optional Parameters:
     ...
     * @param "Flagged" (optional.Bool) -  If set to &#x60;true&#x60;, lists only flagged messages. If set to &#x60;false&#x60;, lists only unflagged messages. if not specified, lists all messages.
     ...
     * @param "Names" (optional.Interface of []string) -  Performs the operation on the unique name specified. For example, &#x60;name01&#x60;. Enter multiple names in comma-separated format. The &#x60;ids&#x60; or &#x60;names&#x60; parameter is required, but both cannot be set together.
...
type AlertsApiApi28AlertsEventsGetOpts struct {
...
func (a *AlertsApiService) Api28AlertsEventsGet(ctx context.Context, localVarOptionals *AlertsApiApi28AlertsEventsGetOpts) (InlineResponse20013, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/2.8/alerts/events"
	...
	if localVarOptionals != nil && localVarOptionals.Flagged.IsSet() {
		localVarQueryParams.Add("flagged", parameterToString(localVarOptionals.Flagged.Value(), ""))
	}
...
/*
AlertsApiService List alerts
Displays a list of alerts.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *AlertsApiApi28AlertsGetOpts - Optional Parameters:
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint (except &#x60;/oauth2&#x60;, &#x60;/login&#x60;, and &#x60;/logout&#x60;)
     * @param "XRequestID" (optional.String) -  Supplied by client during request or generated by server.
     * @param "ContinuationToken" (optional.String) -  A token used to retrieve the next page of data with some consistency guaranteed. The token is a Base64 encoded value. Set &#x60;continuation_token&#x60; to the system-generated token taken from the &#x60;x-next-token&#x60; header field of the response. A query has reached its last page when the response does not include a token. Pagination requires the &#x60;limit&#x60; and &#x60;continuation_token&#x60; query parameters.
     * @param "Filter" (optional.String) -  Narrows down the results to only the response objects that satisfy the filter criteria.
...
type AlertsApiApi28AlertsGetOpts struct {
    Authorization optional.String
    XRequestID optional.String
    ContinuationToken optional.String
    Filter optional.String
...
func (a *AlertsApiService) Api28AlertsGet(ctx context.Context, localVarOptionals *AlertsApiApi28AlertsGetOpts) (InlineResponse20011, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/2.8/alerts"
...
/*
AlertsApiService Modify flagged state
Modifies one or more alerts and display updated information about these alerts.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
 * @param optional nil or *AlertsApiApi28AlertsPatchOpts - Optional Parameters:
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint (except &#x60;/oauth2&#x60;, &#x60;/login&#x60;, and &#x60;/logout&#x60;)
     * @param "XRequestID" (optional.String) -  Supplied by client during request or generated by server.
     * @param "Ids" (optional.Interface of []string) -  Performs the operation on the unique resource IDs specified. Enter multiple resource IDs in comma-separated format. The &#x60;ids&#x60; and &#x60;names&#x60; parameters cannot be provided together.
     * @param "Names" (optional.Interface of []string) -  Performs the operation on the unique name specified. Enter multiple names in comma-separated format. For example, &#x60;name01,name02&#x60;.
...
type AlertsApiApi28AlertsPatchOpts struct {
    Authorization optional.String
    XRequestID optional.String
    Ids optional.Interface
    Names optional.Interface
...
func (a *AlertsApiService) Api28AlertsPatch(ctx context.Context, body Alert, localVarOptionals *AlertsApiApi28AlertsPatchOpts) (InlineResponse20012, *http.Response, error) {
	var (
