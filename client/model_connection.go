...
type Connection struct {
	Host *Api28certificatescertificatesigningrequestsCertificate `json:"host,omitempty"`
	HostGroup *Api28certificatescertificatesigningrequestsCertificate `json:"host_group,omitempty"`
	...
	Volume *ConnectionVolume `json:"volume,omitempty"`
}
