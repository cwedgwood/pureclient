...
/*
ControllersApiService List controller information and status
 ...
 * @param optional nil or *ControllersApiApi28ControllersGetOpts - Optional Parameters:
...
type ControllersApiApi28ControllersGetOpts struct {
...
func (a *ControllersApiService) Api28ControllersGet(ctx context.Context, localVarOptionals *ControllersApiApi28ControllersGetOpts) (InlineResponse20043, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/2.8/controllers"
