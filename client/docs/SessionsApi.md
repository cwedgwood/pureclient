...
------------- | ------------- | -------------
[**Api28SessionsGet**](SessionsApi.md#Api28SessionsGet) | **Get** /api/2.8/sessions | List session data

# **Api28SessionsGet**
> InlineResponse200135 Api28SessionsGet(ctx, optional)
List session data
 ...
 **optional** | ***SessionsApiApi28SessionsGetOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a SessionsApiApi28SessionsGetOpts struct
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
