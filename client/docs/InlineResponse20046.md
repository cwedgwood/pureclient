...
**Items** | [**[]DirectoryPerformance**](DirectoryPerformance.md) | Performance data. If &#x60;total_only&#x3D;true&#x60;, the &#x60;items&#x60; list will be empty. | [optional] [default to null]
**Total** | [**[]DirectoryPerformance**](DirectoryPerformance.md) | The aggregate value of all items after filtering. When it makes sense, the average value is displayed instead. The values are displayed for each field if meaningful. | [optional] [default to null]
