...
**Items** | [**[]PodPerformanceReplicationByArray**](PodPerformanceReplicationByArray.md) | A list of pod performance replication objects, arranged by array. | [optional] [default to null]
**Total** | [**[]PodPerformanceReplicationByArray**](PodPerformanceReplicationByArray.md) | The aggregate value of all items after filtering. When applicable, the average value is displayed instead. The values are displayed for each field if meaningful. | [optional] [default to null]
