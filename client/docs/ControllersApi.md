...
------------- | ------------- | -------------
[**Api28ControllersGet**](ControllersApi.md#Api28ControllersGet) | **Get** /api/2.8/controllers | List controller information and status

# **Api28ControllersGet**
> InlineResponse20043 Api28ControllersGet(ctx, optional)
 ...
 **optional** | ***ControllersApiApi28ControllersGetOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a ControllersApiApi28ControllersGetOpts struct
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
