...
/*
ConnectionsApiService Delete a connection between a volume and its host or host group
 ...
 * @param optional nil or *ConnectionsApiApi28ConnectionsDeleteOpts - Optional Parameters:
     ...
     * @param "HostGroupNames" (optional.Interface of []string) -  Performs the operation on the host group specified. Enter multiple names in comma-separated format. A request cannot include a mix of multiple objects with multiple names. For example, a request cannot include a mix of multiple host group names and volume names; instead, at least one of the objects (e.g., &#x60;host_group_names&#x60;) must be set to only one name (e.g., &#x60;hgroup01&#x60;).
     * @param "HostNames" (optional.Interface of []string) -  Performs the operation on the hosts specified. Enter multiple names in comma-separated format. For example, &#x60;host01,host02&#x60;. A request cannot include a mix of multiple objects with multiple names. For example, a request cannot include a mix of multiple host names and volume names; instead, at least one of the objects (e.g., &#x60;host_names&#x60;) must be set to only one name (e.g., &#x60;host01&#x60;).
     * @param "VolumeNames" (optional.Interface of []string) -  Performs the operation on the volume specified. Enter multiple names in comma-separated format. For example, &#x60;vol01,vol02&#x60;. A request cannot include a mix of multiple objects with multiple names. For example, a request cannot include a mix of multiple volume names and host names; instead, at least one of the objects (e.g., &#x60;volume_names&#x60;) must be set to only one name (e.g., &#x60;vol01&#x60;).

*/

type ConnectionsApiApi28ConnectionsDeleteOpts struct {
    Authorization optional.String
    XRequestID optional.String
    HostGroupNames optional.Interface
    HostNames optional.Interface
    VolumeNames optional.Interface
}

func (a *ConnectionsApiService) Api28ConnectionsDelete(ctx context.Context, localVarOptionals *ConnectionsApiApi28ConnectionsDeleteOpts) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/2.8/connections"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}

	if localVarOptionals != nil && localVarOptionals.HostGroupNames.IsSet() {
		localVarQueryParams.Add("host_group_names", parameterToString(localVarOptionals.HostGroupNames.Value(), "csv"))
	}
	if localVarOptionals != nil && localVarOptionals.HostNames.IsSet() {
		localVarQueryParams.Add("host_names", parameterToString(localVarOptionals.HostNames.Value(), "csv"))
	}
	if localVarOptionals != nil && localVarOptionals.VolumeNames.IsSet() {
		localVarQueryParams.Add("volume_names", parameterToString(localVarOptionals.VolumeNames.Value(), "csv"))
	}
...
/*
ConnectionsApiService List volume connections
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ConnectionsApiApi28ConnectionsGetOpts - Optional Parameters:
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint (except &#x60;/oauth2&#x60;, &#x60;/login&#x60;, and &#x60;/logout&#x60;)
     * @param "XRequestID" (optional.String) -  Supplied by client during request or generated by server.
     ...
     * @param "ProtocolEndpointNames" (optional.Interface of []string) -  Performs the operation on the protocol endpoints specified. Enter multiple names in comma-separated format. For example, &#x60;pe01,pe02&#x60;. A request cannot include a mix of multiple objects with multiple names. For example, a request cannot include a mix of multiple protocol endpoint names and host names; instead, at least one of the objects (e.g., &#x60;protocol_endpoint_names&#x60;) must be set to one name (e.g., &#x60;pe01&#x60;).
...
type ConnectionsApiApi28ConnectionsGetOpts struct {
    Authorization optional.String
    XRequestID optional.String
    ...
    ProtocolEndpointNames optional.Interface
    Sort optional.Interface
    TotalItemCount optional.Bool
    VolumeNames optional.Interface
}

func (a *ConnectionsApiService) Api28ConnectionsGet(ctx context.Context, localVarOptionals *ConnectionsApiApi28ConnectionsGetOpts) (InlineResponse20041, *http.Response, error) {
	var (
	...
	if localVarOptionals != nil && localVarOptionals.ProtocolEndpointNames.IsSet() {
		localVarQueryParams.Add("protocol_endpoint_names", parameterToString(localVarOptionals.ProtocolEndpointNames.Value(), "csv"))
	}
...
/*
ConnectionsApiService Create a connection between a volume and host or host group
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ConnectionsApiApi28ConnectionsPostOpts - Optional Parameters:
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint (except &#x60;/oauth2&#x60;, &#x60;/login&#x60;, and &#x60;/logout&#x60;)
     * @param "XRequestID" (optional.String) -  Supplied by client during request or generated by server.
     * @param "HostGroupNames" (optional.Interface of []string) -  Performs the operation on the host group specified. Enter multiple names in comma-separated format. A request cannot include a mix of multiple objects with multiple names. For example, a request cannot include a mix of multiple host group names and volume names; instead, at least one of the objects (e.g., &#x60;host_group_names&#x60;) must be set to only one name (e.g., &#x60;hgroup01&#x60;).
     * @param "HostNames" (optional.Interface of []string) -  Performs the operation on the hosts specified. Enter multiple names in comma-separated format. For example, &#x60;host01,host02&#x60;. A request cannot include a mix of multiple objects with multiple names. For example, a request cannot include a mix of multiple host names and volume names; instead, at least one of the objects (e.g., &#x60;host_names&#x60;) must be set to only one name (e.g., &#x60;host01&#x60;).
...
type ConnectionsApiApi28ConnectionsPostOpts struct {
    Authorization optional.String
    XRequestID optional.String
    HostGroupNames optional.Interface
    HostNames optional.Interface
...
func (a *ConnectionsApiService) Api28ConnectionsPost(ctx context.Context, body Model28ConnectionsBody, localVarOptionals *ConnectionsApiApi28ConnectionsPostOpts) (InlineResponse20042, *http.Response, error) {
	var (
