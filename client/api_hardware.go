...
/*
HardwareApiService List hardware component information
Displays a list of hardware slots and bays and status of installed components.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *HardwareApiApi28HardwareGetOpts - Optional Parameters:
...
type HardwareApiApi28HardwareGetOpts struct {
...
func (a *HardwareApiService) Api28HardwareGet(ctx context.Context, localVarOptionals *HardwareApiApi28HardwareGetOpts) (InlineResponse20068, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/2.8/hardware"
...
/*
HardwareApiService Modify visual identification
Modifies the visual identification of a specified hardware component, and causing the ID LED to turn on or off.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
 * @param optional nil or *HardwareApiApi28HardwarePatchOpts - Optional Parameters:
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint (except &#x60;/oauth2&#x60;, &#x60;/login&#x60;, and &#x60;/logout&#x60;)
     * @param "XRequestID" (optional.String) -  Supplied by client during request or generated by server.
     * @param "Names" (optional.Interface of []string) -  Performs the operation on the unique name specified. Enter multiple names in comma-separated format. For example, &#x60;name01,name02&#x60;.
...
type HardwareApiApi28HardwarePatchOpts struct {
    Authorization optional.String
    XRequestID optional.String
    Names optional.Interface
}

func (a *HardwareApiService) Api28HardwarePatch(ctx context.Context, body Model28HardwareBody, localVarOptionals *HardwareApiApi28HardwarePatchOpts) (InlineResponse20069, *http.Response, error) {
	var (
