...
/*
KMIPApiService Delete KMIP server object
Deletes KMIP server objects.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *KMIPApiApi28KmipDeleteOpts - Optional Parameters:
...
type KMIPApiApi28KmipDeleteOpts struct {
    Authorization optional.String
    XRequestID optional.String
    Names optional.Interface
}

func (a *KMIPApiService) Api28KmipDelete(ctx context.Context, localVarOptionals *KMIPApiApi28KmipDeleteOpts) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/2.8/kmip"
...
/*
KMIPApiService List KMIP server objects
Displays the list of KMIP server objects.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *KMIPApiApi28KmipGetOpts - Optional Parameters:
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint (except &#x60;/oauth2&#x60;, &#x60;/login&#x60;, and &#x60;/logout&#x60;)
     * @param "XRequestID" (optional.String) -  Supplied by client during request or generated by server.
...
type KMIPApiApi28KmipGetOpts struct {
    Authorization optional.String
    XRequestID optional.String
...
func (a *KMIPApiService) Api28KmipGet(ctx context.Context, localVarOptionals *KMIPApiApi28KmipGetOpts) (InlineResponse20080, *http.Response, error) {
	var (
...
/*
KMIPApiService Modify KMIP attributes
Modifies one or more attributes of KMIP server objects.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
 * @param optional nil or *KMIPApiApi28KmipPatchOpts - Optional Parameters:
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint (except &#x60;/oauth2&#x60;, &#x60;/login&#x60;, and &#x60;/logout&#x60;)
     * @param "XRequestID" (optional.String) -  Supplied by client during request or generated by server.
     * @param "Names" (optional.Interface of []string) -  Performs the operation on the unique name specified. Enter multiple names in comma-separated format. For example, &#x60;name01,name02&#x60;.
...
type KMIPApiApi28KmipPatchOpts struct {
    Authorization optional.String
    XRequestID optional.String
    Names optional.Interface
}

func (a *KMIPApiService) Api28KmipPatch(ctx context.Context, body Kmip, localVarOptionals *KMIPApiApi28KmipPatchOpts) (InlineResponse20081, *http.Response, error) {
	var (
...
/*
KMIPApiService Create KMIP server object
Creates KMIP server objects.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
 * @param optional nil or *KMIPApiApi28KmipPostOpts - Optional Parameters:
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint (except &#x60;/oauth2&#x60;, &#x60;/login&#x60;, and &#x60;/logout&#x60;)
     * @param "XRequestID" (optional.String) -  Supplied by client during request or generated by server.
     * @param "Names" (optional.Interface of []string) -  Performs the operation on the unique name specified. Enter multiple names in comma-separated format. For example, &#x60;name01,name02&#x60;.
@return InlineResponse20081
...
type KMIPApiApi28KmipPostOpts struct {
    Authorization optional.String
    XRequestID optional.String
    Names optional.Interface
}

func (a *KMIPApiService) Api28KmipPost(ctx context.Context, body Kmip, localVarOptionals *KMIPApiApi28KmipPostOpts) (InlineResponse20081, *http.Response, error) {
	var (
...
/*
KMIPApiService Lists KMIP connection tests
 ...
 * @param optional nil or *KMIPApiApi28KmipTestGetOpts - Optional Parameters:
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint (except &#x60;/oauth2&#x60;, &#x60;/login&#x60;, and &#x60;/logout&#x60;)
     * @param "XRequestID" (optional.String) -  Supplied by client during request or generated by server.
@return InlineResponse20082
*/

type KMIPApiApi28KmipTestGetOpts struct {
    Authorization optional.String
    XRequestID optional.String
}

func (a *KMIPApiService) Api28KmipTestGet(ctx context.Context, names []string, localVarOptionals *KMIPApiApi28KmipTestGetOpts) (InlineResponse20082, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/2.8/kmip/test"
