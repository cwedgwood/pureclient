...
type SessionsApiApi28SessionsGetOpts struct {
...
func (a *SessionsApiService) Api28SessionsGet(ctx context.Context, localVarOptionals *SessionsApiApi28SessionsGetOpts) (InlineResponse200135, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/2.8/sessions"
