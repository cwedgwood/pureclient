...
type DNSApiApi28DnsGetOpts struct {
...
func (a *DNSApiService) Api28DnsGet(ctx context.Context, localVarOptionals *DNSApiApi28DnsGetOpts) (InlineResponse20062, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/2.8/dns"
...
/*
DNSApiService Modify DNS parameters
Modifies the DNS parameters of an array, including the domain suffix and the list of DNS name server IP addresses.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
 * @param optional nil or *DNSApiApi28DnsPatchOpts - Optional Parameters:
     * @param "Authorization" (optional.String) -  Access token (in JWT format) required to use any API endpoint (except &#x60;/oauth2&#x60;, &#x60;/login&#x60;, and &#x60;/logout&#x60;)
     * @param "XRequestID" (optional.String) -  Supplied by client during request or generated by server.
@return InlineResponse20063
*/

type DNSApiApi28DnsPatchOpts struct {
    Authorization optional.String
    XRequestID optional.String
}

func (a *DNSApiService) Api28DnsPatch(ctx context.Context, body Model28DnsBody, localVarOptionals *DNSApiApi28DnsPatchOpts) (InlineResponse20063, *http.Response, error) {
	var (
